...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\STOMASERVCIE\PycharmProjects\continue\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\STOMASERVCIE\PycharmProjects\continue\venv\Scripts\deactivate.nu'
